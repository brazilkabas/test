...
export function SecuritySettings() {
  ...
  return <>
    <div className="page-header"><div><h1>Security and access</h1><p className="muted">Application controls and safe configuration state—secret values are never shown</p></div><div className="row"><Link className="button secondary" href="/admin/settings/brand-assets">Brand Assets</Link><Link className="button secondary" href="/admin/settings/cloudflare">Cloudflare</Link></div></div>
