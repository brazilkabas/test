...
export function SecuritySettings() {
  ...
  return <>
    <div className="page-header"><div><h1>Security and access</h1><p className="muted">Application controls and safe configuration state—secret values are never shown</p></div></div>
