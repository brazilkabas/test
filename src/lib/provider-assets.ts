...
const microsoftFamily = {
  ...
  assetPolicy: "Unmodified Microsoft Fluent product icon served from the application's local provider asset bundle.",
};

export const providerAssets: Record<BuilderConfiguration["provider"], ProviderPreset> = {
  microsoft365: {
    id: "microsoft365", name: "Microsoft 365", logoSrc: "/providers/microsoft365/microsoft365.svg", logoAlt: "Microsoft 365", accent: "#0f6cbd",
  ...
  sharepoint: {
    id: "sharepoint", name: "SharePoint", logoSrc: "/providers/sharepoint/sharepoint.svg", logoAlt: "SharePoint", accent: "#03787c",
  ...
  onedrive: {
    id: "onedrive", name: "OneDrive", logoSrc: "/providers/onedrive/onedrive.svg", logoAlt: "OneDrive", accent: "#0078d4",
  ...
  adobe: {
    id: "adobe", name: "Adobe Acrobat Sign", logoSrc: "/providers/adobe/pdf-file-icon.png", logoAlt: "Adobe PDF", accent: "#d31510",
    ...
    assetPolicy: "Official unmodified Adobe PDF file icon under Adobe's web-icon terms; Acrobat product logos require separate written permission.",
  ...
  docusign: {
    id: "docusign", name: "Docusign", logoSrc: "/providers/docusign/docusign.svg", logoAlt: "Docusign", accent: "#4c00ff",
